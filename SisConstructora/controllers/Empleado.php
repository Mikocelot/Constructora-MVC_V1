			...
			while ($reg=$rspta->fetch_object()) {
				$data[] = array(
					"0"=>$reg->nombre,
	 				...
	 				"6"=>$reg->salario_hora,
	 				"7"=>$reg->nombreobra,
	 				"8"=>'<button class="btn btn-primary btn-sm" onclick="mostrar('.$reg->idempleado.')"> <i class="material-icons">edit</i></button>'.
 					' <button class="btn btn-danger btn-sm" onclick="eliminar('.$reg->idempleado.')"> <i class="material-icons">delete</i></button>'
				);
			}
			$results = array(
