			...
			while ($reg=$rspta->fetch_object()) {
				$data[] = array(
					"0"=>$reg->nombre_empresa,
	 				...
	 				"5"=>'<button class="btn btn-primary btn-sm" onclick="mostrar('.$reg->idproveedor.')"> <i class="material-icons">edit</i></button>'.
 					' <button class="btn btn-danger btn-sm" onclick="eliminar('.$reg->idproveedor.')"><i class="material-icons">delete</i></button>'
				);
			}
			$results = array(
